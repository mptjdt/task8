...
namespace 墨心.Task8 {
    public class 世界系统 : I世界系统 {
        public Dictionary<Vector2Int, GameObject> 所有矿石 { get; set; } = new();
        public Dictionary<Vector2Int, GameObject> 所有土质 { get; set; } = new();
        public Dictionary<Vector2Int, GameObject> 所有建筑 { get; set; } = new();
